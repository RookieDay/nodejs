{
  "source": "https://nodejs.org/dist/latest-v5.x/docs/api/doc/api/child_process.md",
  "modules": [
    {
                  ...
                  "params": [
                    ...
                    },
                    {
                      ...
                      "options": [
                        ...
                        {
                          "textRaw": "`shell` {String} Shell to execute the command with (Default: '/bin/sh' on UNIX, 'https://nodejs.org/dist/latest-v5.x/docs/api/cmd.exe' on Windows,  The shell should  understand the `-c` switch on UNIX or `/s /c` on Windows. On Windows,  command line parsing should be compatible with `cmd.exe`.) ",
                          "name": "shell",
                          "type": "String",
                          "desc": "Shell to execute the command with (Default: '/bin/sh' on UNIX, 'https://nodejs.org/dist/latest-v5.x/docs/api/cmd.exe' on Windows,  The shell should  understand the `-c` switch on UNIX or `/s /c` on Windows. On Windows,  command line parsing should be compatible with `cmd.exe`.)"
                        },
                        {
                  ...
                  "params": [
                    ...
                    },
                    {
                      ...
                      "options": [
                        ...
                        {
                          "textRaw": "`shell` {Boolean|String} If `true`, runs `command` inside of a shell. Uses '/bin/sh' on UNIX, and 'https://nodejs.org/dist/latest-v5.x/docs/api/cmd.exe' on Windows. A different shell can be specified as a string. The shell should understand the `-c` switch on UNIX, or `/s /c` on Windows. Defaults to `false` (no shell). ",
                          "name": "shell",
                          "type": "Boolean|String",
                          "desc": "If `true`, runs `command` inside of a shell. Uses '/bin/sh' on UNIX, and 'https://nodejs.org/dist/latest-v5.x/docs/api/cmd.exe' on Windows. A different shell can be specified as a string. The shell should understand the `-c` switch on UNIX, or `/s /c` on Windows. Defaults to `false` (no shell)."
                        }
                      ],
                      "name": "options",
                      "type": "Object",
